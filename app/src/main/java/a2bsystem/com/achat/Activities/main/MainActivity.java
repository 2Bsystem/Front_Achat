package a2bsystem.com.achat.Activities.main;
...
import a2bsystem.com.achat.Activities.config.Config;
import a2bsystem.com.achat.Activities.consultation.Consultations;
        ...
        protected void onPostExecute(String output) {
            ...
            if(output.equalsIgnoreCase("-1"))
            {
                ...
                try {
                    ...
                    Helper.acheteur = jsonObject.getString("Acheteur");
                    Helper.depot = jsonObject.getString("Depot");


                    if(jsonObject.getInt("Connexion") == 1) {
                        Intent Consultation = new Intent(MainActivity.this, Consultations.class);
